...
zakraGenerateCSS( 'zakra_header_button_bg_color', '.main-navigation.tg-primary-menu > div ul li.tg-header-button-wrap a, .tg-mobile-navigation > div ul li.tg-header-button-wrap a', 'background-color' );
...
zakraGenerateCSS( 'zakra_header_button_roundness', '.main-navigation.tg-primary-menu > div ul li.tg-header-button-wrap a, .tg-mobile-navigation .tg-header-button-wrap a', 'border-radius', 'px' );
